...
function validarFormulario(){
    ...
    camposTexto.forEach( campo => {
        ...
        if (campo.value.length == ''){
            ...
            mostrarError(errorCampo, 'Se requiere al menos 3 caracteres')
            validacionCorrecta = false;
        }
        else {
    ...
    if(edad.value < 18 ){
        mostrarError(errorEdad, 'Debes ser mayor de edad para regristrarte!');
        validacionCorrecta = false;
    }
    else{
    ...
    if(actividad == ''){
        mostrarError(errorActividad, 'Debes seleccionar al menos una!');
        validacionCorrecta = false;
    }
    else {
